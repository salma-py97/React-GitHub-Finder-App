// rce
// this component will not have state but it's gonna have a lifeCycle method, ComponentDidMount to fire off the getUser function that we created in App.js
